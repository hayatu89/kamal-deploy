defmodule KamalWeb.PaymentLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :payments, Finance.list_payments())}
  end
  ...
  @impl true
  def handle_info({KamalWeb.PaymentLive.FormComponent, {:saved, payment}}, socket) do
    {:noreply, stream_insert(socket, :payments, payment)}
  end

  @impl true
  def handle_event("delete", %{"id" => id}, socket) do
    payment = Finance.get_payment!(id)
    {:ok, _} = Finance.delete_payment(payment)
