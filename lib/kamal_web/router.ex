defmodule KamalWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {KamalWeb.Layouts, :root}
  ...
  # scope "/api", KamalWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:kamal, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: KamalWeb.Telemetry
